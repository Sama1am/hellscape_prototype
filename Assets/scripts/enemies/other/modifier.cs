...
public class modifier : MonoModifier
{
    //because we are not using any other modifiers provided with A* and are using our own, we can change the value from 60 to 10, 10
    //depending on the number certain modifiers will get called first, so 10 is called first then 20 and so on 
